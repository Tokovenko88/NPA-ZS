...
| `ui/notes.php` | Примечания к элементам/заголовкам | `isOriginalRevision`, `splitChangerIds`, `isIntroductionInheritedFromAncestor`, `getItemHeadRevisionNotes`, `getElementRevisionNotes` |
