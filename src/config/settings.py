...
_SETTINGS_FIELDS = [
    ...
    'ollama_base_url',
    # LLM — HTTP-бэкенды (все используют OpenAI-compatible /chat/completions)
...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        cline_base_url=os.environ.get('CLINE_BASE_URL', ''),
        cline_default_model=os.environ.get('CLINE_DEFAULT_MODEL', ''),
        openrouter_api_key=os.environ.get('OPENROUTER_API_KEY', ''),
        openrouter_base_url=os.environ.get('OPENROUTER_BASE_URL', ''),
        openrouter_default_model=os.environ.get('OPENROUTER_DEFAULT_MODEL', ''),
        deepseek_api_key=os.environ.get('DEEPSEEK_API_KEY', ''),
        deepseek_base_url=os.environ.get('DEEPSEEK_BASE_URL', ''),
        deepseek_default_model=os.environ.get('DEEPSEEK_DEFAULT_MODEL', ''),
